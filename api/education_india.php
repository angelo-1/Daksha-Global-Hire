        ...
        <section class="" style="background-image: url('img/cc.jpg');background-repeat: no-repeat;background-size: cover;" data-stellar-background-ratio="0.5">
            ...
            <div class="container">
              <div class="row no-gutters slider-text align-items-end">
                <div class="col-md-9 ftco-animate pb-5">
                  ...
                  <h1 class="mb-0 bread">Education all over India</h1>
                </div>
              </div>
            </div>
          </section>
          ...
          <div class="row no-gutters">
            <div class="col-md-5 d-flex  ftco-animate">
              <div class="info-wrap w-100 p-5 " style="background-image: url(img/img5.jpg);">
              </div>
            </div>
            <div class="col-md-7 ftco-animate">
              <div class="contact-wrap w-100 p-md-5 p-4">
                ...
                <span style="font-size: 17px;">India is now witnessing the era of science and technology. Education in India has now reorganized itself to emphasize how essential technology is in our everyday life. Students are being trained in these spheres as per the need the time.Through Daksha you can enroll into the top colleges in india for quality education.</span><br>
