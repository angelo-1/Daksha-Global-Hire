        ...
        <section class="" style="background-image: url('img/cc.jpg');background-repeat: no-repeat;background-size: cover;" data-stellar-background-ratio="0.5">
            ...
            <div class="container">
              <div class="row no-gutters slider-text align-items-end">
                <div class="col-md-9 ftco-animate pb-5">
                    <p class="breadcrumbs" style="margin-top: 170px;"><span class="mr-2"><a href="index.php" style="color: black;">Home <i class="fa fa-chevron-right"></i></a></span> <span style="color: #0d9e58;">Services <i class="fa fa-chevron-right"></i></span></p>
                  <h1 class="mb-0 bread">Job Opportunities</h1>
                </div>
              </div>
            </div>
          </section>
          ...
          <div class="row no-gutters">
            <div class="col-md-5 d-flex  ftco-animate">
              <div class="info-wrap w-100 p-5 " style="background-image: url(img/project-6.jpg);">
              </div>
            </div>
            <div class="col-md-7 ftco-animate">
              <div class="contact-wrap w-100 p-md-5 p-4">
                <h2 class="mb-4" style="color: var(--blue);">Explore the World with Daksha - Your Gateway to Global Learning</h2>
                <!-- <div id="message" ><h3>Why Study Abroad with Us:</h3></div>  -->
                <span style="font-size: 17px;">Welcome to the career hub of Daksha, where talent meets opportunity. We believe in fostering a dynamic and inclusive work environment that encourages growth, innovation, and collaboration. If you are passionate, driven, and ready to make a difference, we invite you to explore the exciting job opportunities awaiting you at Daksha.</span><br>
