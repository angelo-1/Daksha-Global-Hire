        ...
        <section class="" style="background-image: url('img/cc.jpg');background-repeat: no-repeat;background-size: cover;" data-stellar-background-ratio="0.5">
            ...
            <div class="container">
              <div class="row no-gutters slider-text align-items-end">
                <div class="col-md-9 ftco-animate pb-5">
                  ...
                  <h1 class="mb-0 bread">Study Abroad</h1>
                </div>
              </div>
            </div>
          </section>
          ...
          <div class="row no-gutters">
            <div class="col-md-5 d-flex  ftco-animate">
              <div class="info-wrap w-100 p-5 " style="background-image: url(img/blog-3.jpg);">
              </div>
            </div>
            <div class="col-md-7 ftco-animate">
              <div class="contact-wrap w-100 p-md-5 p-4">
                ...
                <span style="font-size: 17px;">Embark on a transformative journey with Daksha, where education knows no borders. Our study abroad program offers an unparalleled opportunity to broaden your horizons, gain cultural insights, and earn academic credits in a global setting.</span><br>
