        ...
        <section class="" style="background-image: url('img/cc.jpg');background-repeat: no-repeat;background-size: cover;" data-stellar-background-ratio="0.5">
            ...
            <div class="container">
              <div class="row no-gutters slider-text align-items-end">
                <div class="col-md-9 ftco-animate pb-5">
                  ...
                  <h1 class="mb-0 bread">Professional Courses</h1>
                </div>
              </div>
            </div>
          </section>
          ...
          <div class="row no-gutters">
            <div class="col-md-5 d-flex  ftco-animate">
              <div class="info-wrap w-100 p-5 " style="background-image: url(img/blog-2.jpg);">
              </div>
            </div>
            <div class="col-md-7 ftco-animate">
              <div class="contact-wrap w-100 p-md-5 p-4">
                <h2 class="mb-4" style="color: var(--blue);">Explore the World with Daksha - Your Gateway to Global Learning</h2>
                <!-- <div id="message" ><h3>Why  choose professional courses with Us:</h3></div>  -->
                <span style="font-size: 17px;">Professional courses provide the best skill sets that are required to survive in any field. They improve the candidate’s personality and enhance the quality of their CVs.It helps an individual shine brighter than his or her competitors.Daksha provides the top career building courses to you.</span><br>
